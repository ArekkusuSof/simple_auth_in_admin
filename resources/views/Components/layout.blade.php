...
<body class="h-full">
    <div class="min-h-full">
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Arekkusu</div>
                            <div class="text-sm font-medium text-gray-400">arekkusu@example.com</div>
                        </div>
                        <button type="button"
        ...
        @if (isset($heading))
            <header class="bg-sky-500/50 shadow-sm">
